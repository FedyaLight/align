...
4. AAF: реализованы импорт аудиокомпозиций с внешними медиа, выбор
   последовательности, сохранение физических аудиоканалов и экспорт
   ...
   Импорт принимает SourceClip/Filler и простые цепочки исходных файлов,
   сохраняет границы в сэмплах и поддерживает отмену. Остались видео,
   встроенные медиа и более сложные монтажные графы AAF; неподдерживаемые
   конструкции сейчас завершаются явной ошибкой. Проверка импорта и
   повторного экспорта с точным сравнением аудиоканалов:
   `script/check-aaf-smoke.py`.
